...
extension AndroidPermissionList on AndroidPermission {
  static Set<AndroidPermission> fromNames(Iterable<String> names) {
    final permissions = SplayTreeSet<AndroidPermission>(
        (a, b) => a.index - b.index)
      ..addAll(names.map((perm) => AndroidPermissionList.get(perm)).nonNulls);
  ...
  Icon get icon {
    switch (this) {
      case AndroidPermission.NONE:
        return const Icon(Mdi.gitlab);
      case AndroidPermission.X_ADMIN_BRICK:
        return const Icon(Mdi.bugOutline);
      case AndroidPermission.X_ADMIN_LOCK:
        return const Icon(Mdi.shieldLockOutline);
      case AndroidPermission.ADMIN:
        return const Icon(Mdi.shieldAccountOutline);
      case AndroidPermission.STORAGE:
        return const Icon(Mdi.folderOutline);
      case AndroidPermission.MICROPHONE:
        return const Icon(Mdi.microphoneOutline);
      case AndroidPermission.CAMERA:
        return const Icon(Mdi.cameraOutline);
      case AndroidPermission.LOCATION:
        return const Icon(Mdi.mapMarkerOutline);
      case AndroidPermission.PHONE:
        return const Icon(Mdi.phoneOutline);
      case AndroidPermission.CALL_LOG:
        return const Icon(Mdi.phoneLogOutline);
      case AndroidPermission.SMS:
        return const Icon(Mdi.messageProcessingOutline);
      case AndroidPermission.CONTACTS:
        return const Icon(Mdi.contactsOutline);
      case AndroidPermission.CALENDAR:
        return const Icon(Mdi.calendarMonthOutline);
      case AndroidPermission.ACTIVITY_RECOGNITION:
        return const Icon(Mdi.run);
      case AndroidPermission.X_SENSORS_BODY:
        return const Icon(Mdi.heartSettingsOutline);
      case AndroidPermission.SENSORS:
        return const Icon(Mdi.fingerprint);
      case AndroidPermission.NEARBY_DEVICES:
        return const Icon(Mdi.accessPointNetwork);
    }
  }
  ...
  String description(AppLocalizations lang) {
    switch (this) {
      case AndroidPermission.NONE:
        return lang.android_permission_none;
      case AndroidPermission.X_ADMIN_BRICK:
        return lang.android_permission_admin_brick;
      case AndroidPermission.X_ADMIN_LOCK:
        return lang.android_permission_admin_lock;
      case AndroidPermission.ADMIN:
        return lang.android_permission_admin;
      case AndroidPermission.STORAGE:
        return lang.android_permission_storage;
      case AndroidPermission.MICROPHONE:
        return lang.android_permission_microphone;
      case AndroidPermission.CAMERA:
        return lang.android_permission_camera;
      case AndroidPermission.LOCATION:
        return lang.android_permission_location;
      case AndroidPermission.PHONE:
        return lang.android_permission_phone;
      case AndroidPermission.CALL_LOG:
        return lang.android_permission_call_log;
      case AndroidPermission.SMS:
        return lang.android_permission_sms;
      case AndroidPermission.CONTACTS:
        return lang.android_permission_contacts;
      case AndroidPermission.CALENDAR:
        return lang.android_permission_calendar;
      case AndroidPermission.ACTIVITY_RECOGNITION:
        return lang.android_permission_activity_recognition;
      case AndroidPermission.X_SENSORS_BODY:
        return lang.android_permission_sensors_body;
      case AndroidPermission.SENSORS:
        return lang.android_permission_sensors;
      case AndroidPermission.NEARBY_DEVICES:
        return lang.android_permission_nearby_devices;
    }
  }
